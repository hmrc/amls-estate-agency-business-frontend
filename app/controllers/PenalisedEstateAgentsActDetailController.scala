...
class PenalisedEstateAgentsActDetailController @Inject()(
                                        ...
                                        formProvider: PenalisedEstateAgentsActDetailFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: PenalisedEstateAgentsActDetailView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(PenalisedEstateAgentsActDetailPage) match {
        case None => form
