...
class PenalisedEstateAgentsActDetailControllerSpec extends SpecBase with MockitoSugar {
  ...
  "PenalisedEstateAgentsActDetail Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, penalisedEstateAgentsActDetailRoute)

      val result = route(application, request).value

      val view = application.injector.instanceOf[PenalisedEstateAgentsActDetailView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PenalisedEstateAgentsActDetailPage, "answer").success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, penalisedEstateAgentsActDetailRoute)
