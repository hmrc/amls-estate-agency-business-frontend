...
class ClientMoneyProtectionSchemeControllerSpec extends SpecBase with MockitoSugar {
  ...
  "ClientMoneyProtectionScheme Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[ClientMoneyProtectionSchemeView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ClientMoneyProtectionSchemePage, true).success.value
